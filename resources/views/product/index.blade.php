    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var product_table = $('#product_table').DataTable({
                buttons: export_button ? pdfButtons('Product Report', '#product_table') : [],
                processing: true,
                serverSide: true,
                fixedHeader:false,
                aaSorting: [
            ...
            if ($(e.target).attr('href') == '#product_stock_report') {
                if (!data_table_initailized) {
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        buttons: export_button ? pdfButtons('Stock Report', '#stock_report_table') : [],
                        processing: true,
                        serverSide: true,
                        scrollY: "75vh",
                        scrollX: true,
                    ...
                    saveColumnVisibility('stock_report_table', 'colvisState_stockk_report');
                    loadColumnVisibility('stock_report_table', 'colvisState_stockk_report');
