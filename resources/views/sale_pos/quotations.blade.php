...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        buttons: export_button ? pdfButtonsWithDate('Quotations Report', '#sell_table') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[0, 'desc']],
    ...
    saveColumnVisibility('sell_table', 'colvisState_quotation');
    loadColumnVisibility('sell_table', 'colvisState_quotation');
