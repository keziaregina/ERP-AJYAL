				...
				<div class="form-group">
						<div class="input-group">
								...
								<span class="input-group-btn">
										<button type="button" class="btn btn-default btn-flat add_new_customer bg-white" data-name=""
				...
				<div class="form-group">
						<div class="input-group">
								<div class="input-group-btn">
										<button type="button" class="btn btn-default btn-flat bg-white" data-toggle="modal"
								...
								<span class="input-group-btn">
										...
										@if (isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1)
												<button type="button" class="btn btn-default btn-flat bg-white" id="weighing_scale_btn" data-toggle="modal"
														data-target="#weighing_scale_modal" title="@lang('lang_v1.weighing_scale')"><i
																class="fa fa-digital-tachograph text-primary fa-lg"></i></button>
										@endif

										<button type="button" class="btn btn-default btn-flat pos_add_quick_product bg-white"
...
<div class="row">
								...
								<div class="input-group">
										...
										@php
												...
												$selected_price_group =
												    !empty($default_price_group_id) && array_key_exists($default_price_group_id, $price_groups)
		...
		@if (in_array('subscription', $enabled_modules))
				<div class="col-md-4 col-sm-6">
						...
						</label><button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="btn btn-link"><i
...
<div class="row">
		<div class="col-sm-12 pos_product_div">
				...
				@endphp
				<table class="table-condensed table-bordered table-striped table-responsive table" id="pos_table">
						<thead>
								<tr>
										<th
										...
										<th class="tw-text-sm md:!tw-text-base tw-font-bold col-md-3 text-center">
												@lang('sale.qty')
										</th>
										@if (!empty($pos_settings['inline_service_staff']))
												<th class="tw-text-sm md:!tw-text-base tw-font-bold col-md-2 text-center">
														@lang('restaurant.service_staff')
												</th>
										@endif
										<th class="tw-text-sm md:!tw-text-base tw-font-bold col-md-2 {{ $hide_tax }} text-center">
