...
<script>
    $(document).ready(function(){
        ...
        sell_return_table = $('#sell_return_table').DataTable({
            buttons: export_button ? pdfButtonsWithDate('Sell Returns Report', '#sell_return_table') : [],
            processing: true,
            serverSide: true,
            fixedHeader:false,
            aaSorting: [[0, 'desc']],
        ...
        saveColumnVisibility('sell_return_table', 'colvisState_sell_return');
        loadColumnVisibility('sell_return_table', 'colvisState_sell_return');
