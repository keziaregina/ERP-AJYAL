            ...
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                if (target == '#psr_by_cat_tab') {
                    if (typeof product_sell_report_by_category_datatable == 'undefined') {
                        ...
                        saveColumnVisibility2('table#product_sell_report_by_category', 'colvisState_table#product_sell_report_by_category');
                        loadColumnVisibility2('table#product_sell_report_by_category', 'colvisState_table#product_sell_report_by_category');
                    } else {
                    ...
                    if (typeof product_sell_report_by_brand_datatable == 'undefined') {
                        product_sell_report_by_brand_datatable = $('table#product_sell_report_by_brand').DataTable({
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    __currency_convert_recursively($(
                                        '#product_sell_report_by_brand'));
                                },
                            });
                    
                        saveColumnVisibility2('table#product_sell_report_by_brand', 'colvisState_table#product_sell_report_by_brand');
                        loadColumnVisibility2('table#product_sell_report_by_brand', 'colvisState_table#product_sell_report_by_brand');
                        } else {
