...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        window.targetTrue = false;
        initNormalInputTax();

        var target = document.getElementById('print-btn');

        if (target) {
            target.addEventListener('mouseenter', function() {
                console.log('Mouse masuk ke tombol print!');
                window.targetTrue = true;
                initInfoInputTax();
            });
            target.addEventListener('mouseleave', function() {
                console.log('Mouse keluar dari tombol print!');
                window.targetTrue = false;
                initNormalInputTax();
            });
        }

        function initInfoInputTax(){
            if ($.fn.DataTable.isDataTable('#input_tax_table')) {
                input_tax_table.destroy();
            }
            if ($.fn.DataTable.isDataTable('#output_tax_datatable')) {
                output_tax_datatable.destroy();
            }
            if ($.fn.DataTable.isDataTable('#expense_tax_datatable')) {
                expense_tax_datatable.destroy();
            }
