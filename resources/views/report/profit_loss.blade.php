...
@section('javascript')
    ...
    var export_button = window.canExport;
            ...
            profit_by_products_table = $('#profit_by_products_table').DataTable({
                buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Products) Report', '#profit_by_products_table') : [],
                processing: true,
                serverSide: true,
                fixedHeader:false,
                "ajax": {
                ...
                if (target == '#profit_by_categories') {
                    if (typeof profit_by_categories_datatable == 'undefined') {
                        profit_by_categories_datatable = $('#profit_by_categories_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Categories) Report', '#profit_by_categories_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    if (typeof profit_by_brands_datatable == 'undefined') {
                        profit_by_brands_datatable = $('#profit_by_brands_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Brands) Report', '#profit_by_brands_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    if (typeof profit_by_locations_datatable == 'undefined') {
                        profit_by_locations_datatable = $('#profit_by_locations_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Locations) Report', '#profit_by_locations_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    if (typeof profit_by_invoice_datatable == 'undefined') {
                        profit_by_invoice_datatable = $('#profit_by_invoice_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Invoice) Report', '#profit_by_invoice_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    if (typeof profit_by_date_datatable == 'undefined') {
                        profit_by_date_datatable = $('#profit_by_date_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Date) Report', '#profit_by_date_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    if (typeof profit_by_customers_table == 'undefined') {
                        profit_by_customers_table = $('#profit_by_customer_table').DataTable({
                            buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Customer) Report', '#profit_by_customer_table') : [],
                            processing: true,
                            serverSide: true,
                            fixedHeader:false,
                            "ajax": {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            profit_by_days_table = $('#profit_by_day_table').DataTable({
                                buttons: export_button ? pdfButtonsWithDate('Profit / Loss (By Day)Report', '#profit_by_day_table') : [],
                                "searching": false,
                                'paging': false,
                                'ordering': false,
                            });
