    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.create_only', in_array('purchase.create_only', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'essentials.purchase_price', in_array('essentials.purchase_price', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('essentials::lang.purchase_price') }}
              </label>
            </div>
          </div>
        </div>
