@foreach( $variations as $variation)
    ...
    @if(auth()->user()->can('essentials.purchase_price'))
        ...
        <div style="visibility: hidden;">
            ...
            {{-- </td> --}}
                    ...
                    {{-- <td> --}}
                        {!! Form::hidden('purchases[' . $row_count . '][discount_percent]', number_format($discount_percent, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts input_number', 'required']); !!}
                    ...
                    {{-- <td class="{{$hide_tax}}"> --}}
                        ...
                        @endphp
                        {!! Form::hidden('purchases[' . $row_count . '][purchase_price_inc_tax]', $dpp_inc_tax, ['class' => 'form-control input-sm purchase_unit_cost_after_tax input_number', 'required']); !!}
                    {{-- </td> --}}
                    {{-- <td> --}}
                        {{-- <span class="row_subtotal_after_tax display_currency">0</span> --}}
                        <input type="hidden" class="row_subtotal_after_tax_hidden" value=0>
                    {{-- </td> --}}
                    {{-- <td class="@if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif"> --}}
                        {!! Form::hidden('purchases[' . $row_count . '][profit_percent]', number_format($variation->profit_percent, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm input_number profit_percent', 'required']); !!}
                    {{-- </td> --}}
                    @if(empty($is_purchase_order))
                    {{-- <td> --}}
                        @if(session('business.enable_editing_product_from_purchase'))
                            {!! Form::hidden('purchases[' . $row_count . '][default_sell_price]', number_format($variation->sell_price_inc_tax, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm input_number default_sell_price', 'required']); !!}
                        @else
                            {{ number_format($variation->sell_price_inc_tax, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}
                        @endif
                    {{-- </td> --}}
                    @if(session('business.enable_lot_number'))
                        ...
                        @endphp
                        {{-- <td> --}}
                            {!! Form::hidden('purchases[' . $row_count . '][lot_number]', $lot_number, ['class' => 'form-control input-sm']); !!}
                        {{-- </td> --}}
                    @endif
                    @if(session('business.enable_product_expiry'))
                        {{-- <td style="text-align: left;"> --}}
                            ...
                            <div class="input-group @if($hide_mfg) hide @endif">
                                ...
                                {!! Form::hidden('purchases[' . $row_count . '][mfg_date]', $mfg_date, ['class' => 'form-control input-sm expiry_datepicker mfg_date', 'readonly']); !!}
                            </div>
                            <b><small>@lang('product.exp_date'):</small></b>
                            <div class="input-group">
                                <span class="input-group-addon">
                                ...
                                {!! Form::hidden('purchases[' . $row_count . '][exp_date]', $exp_date, ['class' => 'form-control input-sm expiry_datepicker exp_date', 'readonly']); !!}
                            </div>
                            @else
                            <div class="text-center">
                                @lang('product.not_applicable')
