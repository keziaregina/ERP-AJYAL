...
<section class="content">
	...
	@else 
	{!! Form::hidden('tax_amount', 0, ['id' => 'tax_amount']); !!}
	{!! Form::hidden('additional_notes', null, ['id' => 'additional_notes']); !!}
	{!! Form::hidden('discount_amount', 0, ['id' => 'discount_amount']); !!}
	@endif
	...
	@else 
	{!! Form::hidden('final_total', 0 , ['id' => 'grand_total_hidden']); !!}
	{!! Form::hidden('discount_type', 'none', ['id' => 'discount_type']); !!}
	{!! Form::hidden('shipping_charges', 0, ['id' => 'shipping_charges']); !!}
