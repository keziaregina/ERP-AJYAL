...
class ReportSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax()){
            ...
            &nbsp;
            <button type="button" data-href="{{action(\'App\Http\Controllers\ReportSettingsController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_barcode_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>&nbsp;  
                    '
                    )
                    ->removeColumn('id')
                ->rawColumns([0, 3])
