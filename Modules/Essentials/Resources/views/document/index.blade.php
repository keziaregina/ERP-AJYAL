	...
	<h4 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">
		...
		<div class="box box-solid">
			...
			<div class="box-tools pull-right">
				<button type="button" class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-righ add_doc">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table id="documentss" class="table table-bordered table-striped documents">
								<thead>
									<tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		saveColumnVisibility('documentss', 'colvisState_documentss');
		loadColumnVisibility('documentss', 'colvisState_documentss');
