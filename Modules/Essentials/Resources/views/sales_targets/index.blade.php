...
@section('content')
    ...
    <!-- /.content -->
    <div class="modal fade" id="set_sales_target_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            sales_target_table = $('#sales_target_table').DataTable({
                buttons: export_button ? pdfButtons('Sales Targets Report', '#sales_target_table') : [],
                processing: true,
                serverSide: true,
                ajax: {
