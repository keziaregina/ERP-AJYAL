$(document).ready(function() {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        buttons: export_button ? pdfButtons('Customers & Suppliers Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        ajax: {
    ...
    register_report_table = $('#register_report_table').DataTable({
        buttons: export_button ? pdfButtons('Registers Report') : [],
        processing: true,
        serverSide: true,
        scrollY:        "75vh",
        scrollX:        true,
    ...
    if ($('#sr_date_filter').length == 1) {
        ...
        sr_sales_report = $('table#sr_sales_report').DataTable({
            buttons: export_button ? pdfButtons('Sales Representatives (Sales) Report') : [],
            processing: true,
            serverSide: true,
            fixedHeader:false,
            aaSorting: [[0, 'desc']],
        ...
        sr_expenses_report = $('table#sr_expenses_report').DataTable({
            buttons: export_button ? pdfButtons('Sales Representatives (Expenses) Report') : [],
            processing: true,
            serverSide: true,
            fixedHeader:false,
            aaSorting: [[0, 'desc']],
        ...
        sr_sales_commission_report = $('table#sr_sales_with_commission_table').DataTable({
            buttons: export_button ? pdfButtons('Sales Representatives (With Commission) Report') : [],
            processing: true,
            serverSide: true,
            fixedHeader:false,
            aaSorting: [[0, 'desc']],
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        buttons: export_button ? pdfButtons('Product Purchases Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[3, 'desc']],
    ...
    if ($('table#product_sell_report_table').length == 1) {
        ...
        product_sell_report = $('table#product_sell_report_table').DataTable({
            buttons: export_button ? pdfButtons('Product Sales Report') : [],
            processing: true,
            serverSide: true,
            fixedHeader:false,
            aaSorting: [[6, 'desc']],
    ...
    product_sell_report_with_purchase_table = $('table#product_sell_report_with_purchase_table').DataTable({
        buttons: export_button ? pdfButtons('Product Saless With Purchases Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[4, 'desc']],
    ...
    product_sell_grouped_report = $('table#product_sell_grouped_report_table').DataTable({
        buttons: export_button ? pdfButtons('Product Sales Grouped Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[1, 'desc']],
    ...
    saveColumnVisibility2('table#lot_report', 'colvisState_table#lot_report');
    loadColumnVisibility2('table#lot_report', 'colvisState_table#lot_report');
    ...
    purchase_payment_report = $('table#purchase_payment_report_table').DataTable({
        buttons: export_button ? pdfButtons('Purchase Payments Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[2, 'desc']],
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        buttons: export_button ? pdfButtons('Sell Payments Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        aaSorting: [[2, 'desc']],
    ...
    items_report_table = $('#items_report_table').DataTable({
        buttons: export_button ? pdfButtons('Items Report') : [],
        processing: true,
        serverSide: true,
        fixedHeader:false,
        ajax: {
